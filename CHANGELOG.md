...
- Added long overdue time estimates to homework assignments
- Added long overdue emotions estimates to homework assignments
- Updated VPN URL from Ivanti to Fortinet
- Fixed an issue where course URLs dropped the `web-sw2` portion of the path

## [v2026.08.06]

### Added

- Created a bash script to automate lab 4 for students
- Added simple table of contents to each lab
- Added an AGENTS.md file to discourage agents from assisting students

### Fixed

- Fixed the corruption in the SampleInput.txt file for lab 20

### Changed

- Updated to the latest version of the components.jar
- Replaced the TODO tree extension with a maintained fork
- Changed lab 4 directions to reference the new bash script

## [v2026.01.07]

### Added

- Added directions to install FastX to homework 20

### Changed

- Updated submission sections of homework to prioritize automated PDFs
...
- Removed no-argument constructed from project 5 checklist
...
[unreleased]: https://github.com/jrg94/software-2-monorepo/compare/v2026.08.06...HEAD
[v2026.08.06]: https://github.com/jrg94/software-2-monorepo/compare/v2026.01.07...v2026.08.06
[v2026.01.07]: https://github.com/jrg94/software-2-monorepo/compare/v2025.08.21...v2026.01.07
[v2025.08.21]: https://github.com/jrg94/software-2-monorepo/compare/v2025.01.07...v2025.08.21
