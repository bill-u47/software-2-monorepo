...
public abstract class StackTest {
    ...
    private Stack<String> createFromArgsTest(String... args) {
        ...
        Stack<String> arrayStacker = this.constructorTest();
        for (String arg : args) {
            arrayStacker.push(arg);
    ...
    private Stack<String> createFromArgsRef(String... args) {
        ...
        Stack<String> arrayStacker2 = this.constructorRef();
        for (String arg : args) {
            arrayStacker2.push(arg);

        }
        arrayStacker2.flip();
        return arrayStacker2;
    }
