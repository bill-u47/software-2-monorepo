...
public final class Program1GeneratedCode1 extends Program1 {
    ...
    public static void main(String[] args) {
         ...
         * "labs/23-bugs-world-bytecode-generator/data/expected-output.txt"
         */
         ...
         * "labs/23-bugs-world-bytecode-generatordata/actual-output.txt"
         */
        ...
        saveCompiledProgram(
                "labs/23-bugs-world-bytecode-generator/data/actual-output.txt",
                cp2);
        /*
         * Disassemble generated code
         */
