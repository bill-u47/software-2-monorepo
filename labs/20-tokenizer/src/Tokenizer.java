...
public final class Tokenizer {
    ...
    public static void main(String[] args) {
        ...
        out.println();
        /*
         * Generate expected output in file
         * "labs/20-tokenizer/data/expected-output.txt"
         */
        out.println("*** Generating expected output ***");
        SimpleWriter tOut = new SimpleWriter1L(
                "labs/20-tokenizer/data/expected-output.txt");
        for (String token : q1) {
        ...
        tOut.close();
        /*
         * Generate actual output in file
         * "labs/20-tokenizer/data/actual-output.txt"
         */
        out.println("*** Generating actual output ***");
        tOut = new SimpleWriter1L("labs/20-tokenizer/data/actual-output.txt");
        for (String token : q2) {
            tOut.println(tokenKind(token) + ": <" + token + ">");
        }
        tOut.close();
